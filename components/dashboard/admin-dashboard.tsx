    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Este é o seu painel de controle administrativo.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
              ...
              <Button variant="outline">Prestadores</Button>
              <Button variant="outline">Agendamentos</Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Visão geral dos serviços</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Dados da plataforma</CardDescription>
          </CardHeader>
          <CardContent>
